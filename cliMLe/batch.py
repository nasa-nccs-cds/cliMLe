...
class BatchServer:
    ...
    def getNextBatch(self):
        ...
        perm_batch =  np.random.permutation(pc_batch).transpose() if (self.shuffleMode == BATCH) else pc_batch.transpose()
        self.currentBatch = perm_batch[0:self.input_size].transpose(), perm_batch[self.input_size:].transpose()
...
if __name__ == "__main__":
    ...
    print
    print "SHUFFLE: BATCH"
    bserv = BatchServer( project, experiment, dset, 80, BATCH )
